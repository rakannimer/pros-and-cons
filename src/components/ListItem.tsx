...
export const ListItem = React.memo(
  React.forwardRef(
    (
      ...
      const animateInClassNames = "animated fadeIn";
      const animateOutClassNames = "animated fadeOut shrink-height";
      const [shouldAnimateOut, setShouldAnimateOut] = React.useState(false);
      return (
        <div
          key={argument.id}
          className={`list-item-container ${
            shouldAnimateIn ? animateInClassNames : ""
          } ${shouldAnimateOut ? animateOutClassNames : ""}`}
          {...rest}
          style={{
